    ...
    bookings.forEach(booking => {
      ...
      if (booking.status === 'confirmed' || booking.status === 'completed') {
        ...
        if (revenueByDay[dayKey]) {
          revenueByDay[dayKey].revenue += booking.totalAmount || 0;
    ...
    bookings.forEach(booking => {
      if (booking.status === 'confirmed' || booking.status === 'completed') {
        ...
        if (vehicle) {
          ...
          categoryStats[category].bookingDays += booking.durationDays || 0;
        }
      }
    });
          ...
          <>
            ...
            <div className="mt-10">
              <div className="flex justify-between items-center mb-4">
                ...
                <Link to="/dashboard/owner/bookings" className="text-sm text-primary hover:underline flex items-center">
                  Voir toutes les réservations <ArrowRight className="h-4 w-4 ml-1" />
                </Link>
              </div>
              <BookingsList />
            </div>
