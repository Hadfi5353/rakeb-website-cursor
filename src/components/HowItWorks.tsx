...
const steps = [
  ...
  },
  {
    ...
    description: "Récupérez les clés et profitez de votre location en toute tranquillité.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Location de voiture entre particuliers simple, sécurisée et économique
          </p>
        </div>
