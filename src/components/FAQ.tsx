...
const faqs = [
  {
    question: "Comment fonctionne la location entre particuliers ?",
    answer: "La location entre particuliers permet aux propriétaires de véhicules de les louer directement à d'autres particuliers. Le processus est simple : créez un compte, trouvez un véhicule qui vous convient, réservez-le et rencontrez le propriétaire pour récupérer les clés."
  },
  {
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">
            Tout ce que vous devez savoir sur la location entre particuliers
          </p>
        </div>
